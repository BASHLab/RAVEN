...
class LIMUBERTConfig:
    def __init__(self, cfg=None):
        self.hidden: int = 72  # Dimension of Hidden Layer in Transformer Encoder
        self.hidden_ff: int = 144  # Dimension of Intermediate Layers in Positionwise Feedforward Net
        self.feature_num: int = 6  # Factorized embedding parameterization

        self.n_layers: int = 4  # Numher of Hidden Layers
        self.n_heads: int = 4  # Numher of Heads in Multi-Headed Attention Layers
        #activ_fn: str = "gelu" # Non-linear Activation Function Type in Hidden Layers
        self.seq_len: int = 120  # Maximum Length for Positional Embeddings
        self.emb_norm: bool = True
        self.hidden_size_s = 3584
